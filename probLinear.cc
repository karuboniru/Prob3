...
int main(int argc, char *argv[])
{
  ...
  if (argc >= 2)
    dcp_in = (double)atof(argv[1]);
  if (argc >= 3)
    h_in = (double)atof(argv[2]);
  if (argc >= 4)
    v_in = (int)atoi(argv[3]);
  ...
  /// mu to E
  ssE.str("");
  ssE << "P(#nu_{e} #rightarrow #nu_{e})"
      << " L = " << BasePath;
  ssL.str("");
  ssL << "P(#nu_{e} #rightarrow #nu_{e})"
      << " E = " << BaseEnergy;
  ...
  /// mu to E
  ssE.str("");
  ssE << "P(#nu_{#mu} #rightarrow #nu_{e})"
      << " L = " << BasePath;
  ssL.str("");
  ssL << "P(#nu_{#mu} #rightarrow #nu_{e})"
      << " E = " << BaseEnergy;
  ...
  /// mu to mu
  ssE.str("");
  ssE << "P(#nu_{#mu} #rightarrow #nu_{#mu})"
      << " L = " << BasePath;
  ssL.str("");
  ssL << "P(#nu_{#mu} #rightarrow #nu_{#mu})"
      << " E = " << BaseEnergy;
  ...
  /// mu to tau
  ssE.str("");
  ssE << "P(#nu_{#mu} #rightarrow #nu_{#tau})"
      << " L = " << BasePath;
  ssL.str("");
  ssL << "P(#nu_{#mu} #rightarrow #nu_{#tau})"
      << " E = " << BaseEnergy;
