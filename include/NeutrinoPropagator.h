...
public:
    ...
    {
        cerr << " Warning NeutrinoPropagator::GetProb(int, int) undefined " << endl;
        return 0.0;
    }

    virtual double GetVacuumProb(int, int, double, double)
    {
        cerr << " Warning NeutrinoPropagator::GetVacuumProb(int, int, double , double ) undefined " << endl;
        return 0.0;
    }
    ...
    {
        cerr << " Warning NeutrinoPropagator::GetPathLength( ) undefined " << endl;
        return 0.0;
    }
